...
export default {
  ...
  apply(ctx) {
    ...
    let _namingP = null
    function _naming() { if (!_namingP) _namingP = (async function(){ const repo = await _repo(); const mod = await import('./namingGuardian.js'); return mod.createNamingGuardian({ fs: repo.getCacheFs(), timer: timer, DEFAULT_CWD: DEFAULT_CWD, getCacheDir: function(){ return getCacheDir.apply(null, arguments) }, getPlatform: function(){ return getPlatform.apply(null, arguments) }, getRepoKey: function(){ return getRepoKey.apply(null, arguments) }, runGh: function(){ return runGh.apply(null, arguments) }, logCtx: logCtx }) })(); return _namingP }
    let _publishP = null
    ...
    let _logP = null
    function _log() { if (!_logP) _logP = (async function(){ const repo = await _repo(); const mod = await import('./logStore.js'); return mod.createLogStore({ fs: repo.getCacheFs(), timer: timer, getCacheDir: function(){ return getCacheDir.apply(null, arguments) }, getPlatform: function(){ return getPlatform.apply(null, arguments) }, DEFAULT_CWD: DEFAULT_CWD }) })(); return _logP }
