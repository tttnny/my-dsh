...
const RE_LICENSED = /MATT_REPO|mattpocock\/skills|skills@latest|installSkills|PREVIEW_VALUES|dsh-mattpocock-skills-deck|FeatherHunter\/dsh-|my-dsh/ // #231 清尾后仅剩可留项：技能仓库常量/安装指引文案/演示预览值；#repo-link 登记本插件自身仓库主页 URL（构建注入产物）；#520 登记作者其他插件静态链接前缀；my-dsh 为分叉维护仓库（@lynn123411 合集）
