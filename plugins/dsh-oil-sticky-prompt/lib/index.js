...
*/
const StickyPromptSettingsSchema = Schema.object({ enabled: Schema.boolean().default(DEFAULT_STICKY_PROMPT_SETTINGS.enabled) });
/**
...
function apply(ctx) {
	ctx.inject(["settings"], (settingsCtx) => {
		settingsCtx.settings.register(STICKY_PROMPT_SETTINGS_NS, StickyPromptSettingsSchema, { applies: "live" });
	});
}
//#endregion
export { apply, name };
