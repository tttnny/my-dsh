 ...
 * exported for reuse.
 *
 * The card is always expanded: the shared page shows one card per tab, so a
 * collapse affordance would only hide the settings the tab was opened for.
 */
...
export function SmoothStreamCard(props: SmoothStreamCardProps) {
  ...
  return (
    <li className={`${css.card} ${css.cardOpen}`}>
