...
function isTokenedHttpUrl(value: unknown): value is string {
...
export function normalizeDesktopSettings(value: unknown): DesktopSettingsView {
...
export async function fetchDesktopSettings(): Promise<DesktopSettingsView> {
